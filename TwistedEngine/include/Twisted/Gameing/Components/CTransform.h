...
namespace Twisted
{
	...
	template<>
	inline YAML::Node YamlSerialize<TransformComponent>(const TransformComponent& transform)
	{
		YAML::Node node;
	...
	template<>
	inline void YamlDeserialize<TransformComponent>(TransformComponent& transform, const YAML::Node& node)
	{
...
REGISTER_COMPONENT(TransformComponent, "CTransform");
