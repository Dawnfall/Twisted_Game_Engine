...
namespace Twisted
{
	...
	//static TempMaterial collectMaterial(const rapidobj::Material& objMaterial)
	//{
	//	TempMaterial mat;
	...
	//static Vertex collectVertex(const rapidobj::Attributes& attributes, const rapidobj::Index& idx)
	//{
	//	Vertex vertex{};
	//	// Position
