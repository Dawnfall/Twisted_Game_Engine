...
[[nodiscard]] inline static Twisted::MouseButton glfwToTwistedButton(int glfwButton) noexcept
{
	switch (glfwButton)
	{
...
[[nodiscard]] inline static int twistedToGlfwButton(Twisted::MouseButton button) noexcept
{
	switch (button)
	{
