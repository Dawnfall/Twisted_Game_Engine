...
namespace Twisted::GL
{
	...
	bool ValidateShader(GLuint id, [[maybe_unused]] const std::string& name,[[maybe_unused]] GLenum shaderType)
	{
		GLint success;
	...
	bool ValidateProgram(GLuint id, [[maybe_unused]] const std::string& name)
	{
		GLint success;
