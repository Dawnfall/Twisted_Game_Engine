...
{
	auto view = app.Game.GetRegistry().view<Twisted::CTransform, Twisted::CCamera>();
	Twisted::InputManager& input = app.WindowManager.m_inputManager;
	...
	{
		transform.Translate(transform.WorldToLocalVector(translateVec * m_moveSpeed, app.Game));
