...
namespace Twisted
{
	...
	const std::string BUILT_IN_SIMPLE_SHADER_NAME = "SimpleShader";

	const std::string MATERIAL_DEFAULT_NAME = "default_material";

	const std::string SHADER_UNIFORM_NAME_MODEL = "model";
	const std::string SHADER_UNIFORM_NAME_VIEW = "view";
	const std::string SHADER_UNIFORM_NAME_PROJECTION = "projection";
}